...
INSERT INTO `note_page` (`page_id`, `space_id`, `user_id`, `parent_id`, `sort_number`, `icon`, `title`, `cover`, `content`, `collect`, `layout`, `font`, `size`, `readonly`, `password`, `share`, `template`, `deleted`, `create_time`, `update_time`) VALUES (1866018553628798978, 1865162461555109890, 1859329812227633153, 1865163733544906754, NULL, '🍊', 'dsff', 'SystemDefaultFiles/images/cover/2.jpg', '{\"type\": \"doc\", \"content\": [{\"type\": \"paragraph\", \"content\": [{\"type\": \"text\"}]}]}', 0, 'default', '默认', '16', '0', NULL, 0, 0, 0, '2024-12-09 15:14:26', '2024-12-21 02:16:14');
...
) ENGINE=InnoDB AUTO_INCREMENT=1870146930162688002 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='笔记空间';
