...
) ENGINE=InnoDB AUTO_INCREMENT=1859331602964754434 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='客户';
...
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (1859330063948787713, 'mu@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$jpq6HipmtzNNj0Z3ZrBkGw$vX6rNTFtaCLGa992QT/iJ8+VwayReyhiBi8jxIjGbsk', '', 'UserFiles/images/avatar/7d3290e6-3492-4fef-8e3a-33635f16de95.jpeg', 0, 0, '2024-11-21 04:16:46', '2024-11-21 04:16:46');
...
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (1859331507322040322, 'ikun@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$LCAZtgq43BFmQIoY9kvifA$KriA2fpY5rsi9W5ErIw86JE9ek8yYt8YpajPRv4zDlY', 'Nex笔记', 'SystemDefaultFiles/images/avatar/avatar-default.png', 0, 1, '2024-11-21 04:22:30', '2024-11-21 04:23:07');
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` (`user_id`, `role_id`, `username`, `email`, `email_verified`, `password`, `nickname`, `phone`, `sex`, `avatar`, `introduction`, `status`, `deleted`, `create_time`, `update_time`) VALUES (123, 1, 'Yoko', '2405824084@qq.com', 0, '$argon2i$v=19$m=65536,t=2,p=1$zNCXciWe2RiG16IEJcTDcA$SKaCzqNex1uBZOHO61pGNedZ3ZOfyU4x4WMFvJy+ffc', 'Yoko', '17877059806', '男', 'SystemDefaultFiles/images/avatar/avatar-admin1.png', '这个人很懒', 0, 0, '2024-11-09 23:16:54', '2024-11-21 03:29:09');
INSERT INTO `sys_user` (`user_id`, `role_id`, `username`, `email`, `email_verified`, `password`, `nickname`, `phone`, `sex`, `avatar`, `introduction`, `status`, `deleted`, `create_time`, `update_time`) VALUES (456, 2, 'Izcw', 'zhang@qq.com', 0, '$argon2i$v=19$m=65536,t=2,p=1$zNCXciWe2RiG16IEJcTDcA$SKaCzqNex1uBZOHO61pGNedZ3ZOfyU4x4WMFvJy+ffc', 'Izcw', '18269328567', '女', 'SystemDefaultFiles/images/avatar/avatar-admin2.png', '这个人很懒', 0, 0, '2024-11-09 23:57:30', '2024-11-21 03:33:41');
INSERT INTO `sys_user` (`user_id`, `role_id`, `username`, `email`, `email_verified`, `password`, `nickname`, `phone`, `sex`, `avatar`, `introduction`, `status`, `deleted`, `create_time`, `update_time`) VALUES (789, 3, 'zhang', 'zhang2@qq.com', 0, '$argon2i$v=19$m=65536,t=2,p=1$zNCXciWe2RiG16IEJcTDcA$SKaCzqNex1uBZOHO61pGNedZ3ZOfyU4x4WMFvJy+ffc', 'nike', '13472583897', '男', 'SystemDefaultFiles/images/avatar/avatar-admin3.png', '这个人很懒', 0, 0, '2024-11-09 23:57:30', '2024-11-21 03:33:42');
COMMIT;
