...
INSERT INTO `note_page` (`page_id`, `space_id`, `user_id`, `parent_id`, `sort_number`, `icon`, `title`, `cover`, `content`, `collect`, `layout`, `font`, `size`, `readonly`, `password`, `bottominfo`, `share`, `template`, `deleted`, `create_time`, `update_time`) VALUES (1865164578495836162, 1865162461555109890, 1859329812227633153, 1865164565594157057, NULL, '🌎', 'New Page', 'SystemDefaultFiles/images/cover/6.jpg', '{\"type\": \"doc\", \"content\": [{\"type\": \"paragraph\", \"content\": [{\"text\": \"开始你的笔记之旅！\", \"type\": \"text\"}]}]}', 0, 'default', '默认', '16', '0', NULL, 0, 0, 0, 0, '2024-12-07 06:41:03', '2024-12-11 00:32:22');
