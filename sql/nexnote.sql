...
CREATE TABLE `note_subscribe`  (
  ...
  `unit` enum('30','90','365') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '30' COMMENT '单位：月、季、年',
  `space` int NULL DEFAULT 3 COMMENT '空间个数',
  `recycle` int NULL DEFAULT 30 COMMENT '回收站最大天数',
  `page_history` int NULL DEFAULT 30 COMMENT '页面编辑历史记录最大天数',
  `page_wordage` int NULL DEFAULT 10000 COMMENT '单页面最大字数，0等于无限',
  `ai` int NULL DEFAULT 5 COMMENT 'AI 每天使用次数，0等于无限',
...
-- ----------------------------
INSERT INTO `note_subscribe` VALUES (9, '普通', 'Lite', '普通用户Lite', 6.00, '30', 3, 30, 30, 10000, 5, 0, 0, 0, '2024-11-21 23:49:51', '2024-11-22 00:08:04');
INSERT INTO `note_subscribe` VALUES (10, '个人Plus+', 'Plus', '个人Plus版', 12.00, '30', 5, 30, 30, 100000, 10, 0, 0, 0, '2024-11-21 23:50:47', '2024-11-22 00:08:04');
INSERT INTO `note_subscribe` VALUES (11, '团队版', 'Team', '团队版', 36.00, '30', 10, 90, 90, 0, 100, 1, 0, 0, '2024-11-21 23:51:35', '2024-11-22 00:12:16');
INSERT INTO `note_subscribe` VALUES (12, '企业版', 'Business', '企业版：AI、字数不限', 48.00, '30', 20, 365, 365, 0, 0, 0, 1, 0, '2024-11-21 23:54:11', '2024-11-22 00:27:31');
...
CREATE TABLE `note_subscribe_ order`  (
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`subscribe_ order_id`) USING BTREE
...
CREATE TABLE `note_user`  (
  ...
  `avatar` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT 'SystemDefaultFiles/images/avatar/avatar-default.png' COMMENT '头像',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1859490692863156227 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '客户' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `note_user` VALUES (1859330612005908481, '456@gmail.com', '$argon2i$v=19$m=65536,t=2,p=1$4SmDSzBZ1q1k/VUzebzd9Q$Tp7k1DA3mIyX4JzqmRu6w1m9vBg5XGIDkfcuMoYde1M', '静静的', 'UserFiles/images/avatar/782146e7-ed97-443f-9c72-7cccbb5e527e.png', 0, 0, '2024-11-21 04:18:57', '2024-11-21 04:18:57');
INSERT INTO `note_user` VALUES (1859331362777935873, 'haha@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$rt5zwtlasrlNqywKELpwTQ$FUH8nqWDWygpQh+HlAyC58uIIvFE7d5H40ra0puBoyo', 'HaHa', 'UserFiles/images/avatar/81fd04de-0421-4f31-95b3-dffb717d5576.jpeg', 0, 0, '2024-11-21 04:21:56', '2024-11-21 04:21:56');
INSERT INTO `note_user` VALUES (1859331453530091521, 'lanqiu@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$plXw9J3v4ynmUZu0nWLt1A$aeJCXTu0h8eb+NKL5/ltWJTsqvDge0y79YFS/KIasjE', 'Nex笔记', 'UserFiles/images/avatar/7eba530c-498d-4ede-98f7-c4a406e832cf.png', 0, 0, '2024-11-21 04:22:17', '2024-11-21 04:22:17');
INSERT INTO `note_user` VALUES (1859331507322040322, 'ikun@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$LCAZtgq43BFmQIoY9kvifA$KriA2fpY5rsi9W5ErIw86JE9ek8yYt8YpajPRv4zDlY', 'Nex笔记', 'UserFiles/images/avatar/17561444-e861-48c5-9a28-6fc2b6df93b7.png', 0, 1, '2024-11-21 04:22:30', '2024-11-21 14:55:29');
INSERT INTO `note_user` VALUES (1859331602964754433, 'gou@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$H6AyQ4DX5Z5wO5OwrMeFZg$UEKkizA8853ibIpdS3W+e1WW1BqbgInNxTDq6pyeTFA', '小狗儿', 'UserFiles/images/avatar/5d18bbf9-1d3d-47d2-aa1a-78e8733f4829.jpg', 0, 0, '2024-11-21 04:22:53', '2024-11-21 04:22:53');
INSERT INTO `note_user` VALUES (1859490692863156226, 'zhezie@qq.om', '$argon2i$v=19$m=65536,t=2,p=1$WvPRTi2speeVhdJ2wCIFYQ$BdeQ9IVbKBZE3SOrSEuOKu0gtQC+7jHsNBc8iidfqQY', '紫则', 'UserFiles/images/avatar/7d20b48a-0ce3-4035-b939-e1b8dbc9aed6.png', 0, 0, '2024-11-21 14:55:03', '2024-11-21 14:55:03');
...
INSERT INTO `sys_menu` VALUES (162, 99, '增值服务条款管理', '/subscribe/term', '', 0, 2, '', 'Warning', 0, '', 0, '2024-10-14 00:48:10', '2024-11-19 23:20:57');
...
INSERT INTO `sys_role_menu` VALUES (1548, 2, 157, '2024-11-01 10:51:28', '2024-11-19 23:09:51');
INSERT INTO `sys_role_menu` VALUES (1549, 2, 158, '2024-11-01 10:51:28', '2024-11-19 23:09:25');
INSERT INTO `sys_role_menu` VALUES (1550, 2, 165, '2024-11-01 10:51:28', '2024-11-19 23:09:11');
INSERT INTO `sys_role_menu` VALUES (1551, 2, 154, '2024-11-01 10:51:28', '2024-11-19 23:12:36');
INSERT INTO `sys_role_menu` VALUES (1552, 2, 155, '2024-11-01 10:51:28', '2024-11-19 23:11:22');
INSERT INTO `sys_role_menu` VALUES (1553, 2, 156, '2024-11-01 10:51:28', '2024-11-19 23:11:25');
