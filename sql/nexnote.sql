...
CREATE TABLE `note_page` (
  ...
  `parent_id` int DEFAULT NULL COMMENT '上级id，0是顶级',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='页面';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='笔记空间';
...
CREATE TABLE `note_subscribe` (
  `subscribe_id` int NOT NULL AUTO_INCREMENT COMMENT '套餐id',
  ...
  `unit` enum('1个月','3个月','12个月') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '1个月' COMMENT '单位：月、季、年',
...
-- ----------------------------
BEGIN;
INSERT INTO `note_subscribe` (`subscribe_id`, `subscribe_name`, `subscribe_code`, `comments`, `price`, `unit`, `create_time`, `update_time`) VALUES (0, '普通', 'Lite', '普通用户Lite', 0.00, '1个月', '2024-11-19 14:16:32', '2024-11-19 22:43:00');
INSERT INTO `note_subscribe` (`subscribe_id`, `subscribe_name`, `subscribe_code`, `comments`, `price`, `unit`, `create_time`, `update_time`) VALUES (1, '个人plus+', 'Plus', '个人Plus', 6.00, '1个月', '2024-11-19 14:17:04', '2024-11-19 22:57:06');
INSERT INTO `note_subscribe` (`subscribe_id`, `subscribe_name`, `subscribe_code`, `comments`, `price`, `unit`, `create_time`, `update_time`) VALUES (2, '团队版', 'Team', '团队Team', 12.00, '1个月', '2024-11-19 14:19:01', '2024-11-19 22:57:16');
INSERT INTO `note_subscribe` (`subscribe_id`, `subscribe_name`, `subscribe_code`, `comments`, `price`, `unit`, `create_time`, `update_time`) VALUES (3, '企业版', 'Business', '企业版Business', 24.00, '1个月', '2024-11-19 22:42:02', '2024-11-19 22:57:20');
COMMIT;

-- ----------------------------
-- Table structure for note_subscribe_ order
-- ----------------------------
DROP TABLE IF EXISTS `note_subscribe_ order`;
CREATE TABLE `note_subscribe_ order` (
  `subscribe_ order_id` int NOT NULL AUTO_INCREMENT COMMENT '套餐id',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`subscribe_ order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- ----------------------------
-- Records of note_subscribe_ order
-- ----------------------------
BEGIN;
COMMIT;
...
CREATE TABLE `note_template` (
  ...
  `user_id` int NOT NULL COMMENT '用户id',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'space' COMMENT '模板名称',
  PRIMARY KEY (`template_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='模板中心';
...
CREATE TABLE `note_user` (
  ...
  `avatar` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '/images/avatar-default.png' COMMENT '头像',
...
) ENGINE=InnoDB AUTO_INCREMENT=1859116936749641730 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='客户';

-- ----------------------------
-- Records of note_user
-- ----------------------------
BEGIN;
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (11, 'zhangchengwei.work@outlook.com', '$argon2i$v=19$m=65536,t=2,p=1$zNCXciWe2RiG16IEJcTDcA$SKaCzqNex1uBZOHO61pGNedZ3ZOfyU4x4WMFvJy+ffc', 'Nex笔记1', 'http://127.0.0.1:8071/api/file_warehouse/images/avatar/default/avatar-default.png', 0, 0, '2024-11-08 16:19:18', '2024-11-20 14:54:47');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (12, '2405824084@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$yls0M2L2vH5YJOdcs+eOEg$Tk595pC49HBHvA5NpAPA75hSgdutH1VoZO0zUa/M3eY', 'Nex笔记2', '/file_warehouse/images/avatar/default/avatar-default.png', 0, 0, '2024-11-09 19:43:57', '2024-11-19 01:46:28');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (13, 'zhang1@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$yls0M2L2vH5YJOdcs+eOEg$Tk595pC49HBHvA5NpAPA75hSgdutH1VoZO0zUa/M3eY', 'Nex笔记3', '/file_warehouse/images/avatar/default/avatar-default.png', 0, 0, '2024-11-09 19:43:57', '2024-11-19 01:46:28');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (14, 'zhang2@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$yls0M2L2vH5YJOdcs+eOEg$Tk595pC49HBHvA5NpAPA75hSgdutH1VoZO0zUa/M3eY', 'Nex笔记4', '/file_warehouse/images/avatar/default/avatar-default.png', 0, 0, '2024-11-09 19:43:57', '2024-11-19 01:46:28');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (15, 'zhang3@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$yls0M2L2vH5YJOdcs+eOEg$Tk595pC49HBHvA5NpAPA75hSgdutH1VoZO0zUa/M3eY', 'Nex笔记5', '/file_warehouse/images/avatar/default/avatar-default.png', 0, 1, '2024-11-09 19:43:57', '2024-11-19 01:46:28');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (16, 'zhang4@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$yls0M2L2vH5YJOdcs+eOEg$Tk595pC49HBHvA5NpAPA75hSgdutH1VoZO0zUa/M3eY', 'Nex笔记6', '/file_warehouse/images/avatar/default/avatar-default.png', 0, 0, '2024-11-09 19:43:57', '2024-11-19 01:46:28');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (17, 'zhang5@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$yls0M2L2vH5YJOdcs+eOEg$Tk595pC49HBHvA5NpAPA75hSgdutH1VoZO0zUa/M3eY', 'Nex笔记7', 'http://127.0.0.1:8071/apihttp://127.0.0.1:8071/api/file_warehouse/images/avatar/default/avatar-default.png', 0, 0, '2024-11-09 19:43:57', '2024-11-20 14:57:27');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (18, 'zhang6@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$yls0M2L2vH5YJOdcs+eOEg$Tk595pC49HBHvA5NpAPA75hSgdutH1VoZO0zUa/M3eY', 'Nex笔记8', '/file_warehouse/images/avatar/default/avatar-default.png', 0, 0, '2024-11-09 19:43:57', '2024-11-19 01:46:28');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (19, 'zhang7@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$yls0M2L2vH5YJOdcs+eOEg$Tk595pC49HBHvA5NpAPA75hSgdutH1VoZO0zUa/M3eY', 'Nex笔记9', '/file_warehouse/images/avatar/default/avatar-default.png', 0, 0, '2024-11-09 19:43:57', '2024-11-19 01:46:28');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (20, 'zhang8@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$yls0M2L2vH5YJOdcs+eOEg$Tk595pC49HBHvA5NpAPA75hSgdutH1VoZO0zUa/M3eY', 'Nex笔记', '/file_warehouse/images/avatar/default/avatar-default.png', 0, 0, '2024-11-09 19:43:57', '2024-11-19 01:46:28');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (21, 'zhang9@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$yls0M2L2vH5YJOdcs+eOEg$Tk595pC49HBHvA5NpAPA75hSgdutH1VoZO0zUa/M3eY', 'Nex笔记', '/file_warehouse/images/avatar/default/avatar-default.png', 0, 0, '2024-11-09 19:43:57', '2024-11-19 01:46:28');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (22, 'zhang10@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$yls0M2L2vH5YJOdcs+eOEg$Tk595pC49HBHvA5NpAPA75hSgdutH1VoZO0zUa/M3eY', 'Nex笔记', '/file_warehouse/images/avatar/default/avatar-default.png', 0, 0, '2024-11-09 19:43:57', '2024-11-19 01:46:28');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (23, 'zhang11@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$yls0M2L2vH5YJOdcs+eOEg$Tk595pC49HBHvA5NpAPA75hSgdutH1VoZO0zUa/M3eY', 'Nex笔记', 'http://127.0.0.1:8071/api/file_warehouse/images/avatar/default/avatar-default.png', 0, 1, '2024-11-09 19:43:57', '2024-11-20 14:55:14');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (24, 'zhang12@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$yls0M2L2vH5YJOdcs+eOEg$Tk595pC49HBHvA5NpAPA75hSgdutH1VoZO0zUa/M3eY', 'Nex笔记', '/file_warehouse/images/avatar/default/avatar-default.png', 0, 0, '2024-11-09 19:43:57', '2024-11-19 01:46:28');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (25, 'zhang88@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$lvL6h6xxkiOod02YwiKDnw$FErkyV8whjdGkXKd32pcnCMCWnr3sv35gG9aKgc5SHo', 'HaHa', '/user.png', 0, 0, '2024-11-18 22:47:16', '2024-11-18 22:47:16');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (26, 'IzcwYoko@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$RrmveCwqxZ/d1ut1INcU2w$ohJaUD6t/WlP8o3FIbK3A5fKYyjDSpTggA/VyqPtd58', 'Lan', '', 0, 0, '2024-11-19 02:00:56', '2024-11-19 02:00:56');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (27, 'BaoZi@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$/YPt4qPE48oNnW6GelBx/w$5HHIS7OuEc0QAKwLOIvCTTAGSp7/4G35h8eoz/f2Qis', 'end', 'http://127.0.0.1:8071/api/file_warehouse/images/avatar/users/b844a30a-52ce-45c8-aa85-5233b8d9de08.png', 0, 0, '2024-11-19 02:03:54', '2024-11-19 02:03:54');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (28, 'WanCai@gmail.com', '$argon2i$v=19$m=65536,t=2,p=1$Z2xBh7FnJQBZyzhs+5CyZQ$orVBcwwXiHfwiB67Gi+ULepVrr94VX8umhn6y9wz7Ug', '晚上', 'http://localhost:8071/api/file_warehouse/images/avatar/users/e4020ad7-eafb-4bc9-89ab-1e42518d37a6.png', 0, 0, '2024-11-19 02:07:59', '2024-11-19 02:07:59');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (29, '996@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$RsatkrJQK5qPkp8AQhB9eg$ln5M5dT4WGevkw0bECz5g4Um/cgUznOTwG/TYh95XBY', '8848钛金手机', 'http://localhost:8071/api/file_warehouse/images/avatar/users/39f7e473-c96a-4651-b1b7-35d930a36282.png', 0, 0, '2024-11-19 02:09:26', '2024-11-19 02:09:26');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (30, 'DaLei@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$cubI+tDmepGo/v9C6yWBMg$8NfWTkR08EgGpkC8fFT32YWgUmN2YzHYP5rb7G68lCo', '打雷', '/file_warehouse/images/avatar/users/0aa236df-16cc-4c37-a936-241df3c6b80d.png', 0, 0, '2024-11-19 02:12:51', '2024-11-19 02:12:51');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (31, '12333@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$dMvHXeZp480TjIaKkN5Xow$mUcU4MVFEF39Y9+8QodXcv7V7r6R+p8V6mVTx6L/hgU', '321', '/file_warehouse/images/avatar/users/b116a3b6-d060-4e3c-8149-08ea84bd171f.png', 0, 0, '2024-11-19 02:13:43', '2024-11-19 02:13:43');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (32, '2405824084BBB@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$LqY2X7PHSwmL4qLBcnaaLQ$+pNNv4vwlfi2SQLUqiKilPtO5/gDefehg5/eYdigwdg', '8888', '/file_warehouse/images/avatar/default/avatar-admin3.png', 0, 0, '2024-11-19 13:11:58', '2024-11-20 02:30:57');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (33, 'nihao@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$cOv1+QEhwb76pkAJZbDLag$vTu9rKqhNE7rXi4JhIDyiCjexN63kdwfuaLtr1gV2BQ', 'uuuz', '', 0, 0, '2024-11-20 08:56:52', '2024-11-20 08:56:52');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (34, 'niha3o@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$koIoU8Fkq02+pSQLKPwn9w$dHZ0omoR2fHrYvK6LyELkJXNEs1y+rGb9dJ7MkFXjLs', '222', '', 0, 0, '2024-11-20 09:03:53', '2024-11-20 09:03:53');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (35, '423@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$rlZDCCH6s/Ejkn8eYft81A$DntGzlKFDY15xio0kwZrD4Toutg0fKXlUXn2nxU+2jY', '324324', '', 0, 0, '2024-11-20 09:09:27', '2024-11-20 09:09:27');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (36, 'yig@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$peY3Db93BUpmAEkm9BebiA$s0OdG+ZueBVQ8ExZr3GHZhMFijYo2VsuryZtqqha5Nw', 'yizi', 'blob:http://localhost:7435/e4f21e07-a72c-4049-8e68-53c79f7ef362', 0, 0, '2024-11-20 10:04:20', '2024-11-20 10:04:20');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (37, 'jk@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$xSvDBijqX+/0OWjNGdvrdA$WOz6MSLv98BADMciL5jsJVqBUnVQo8FMFmblKm+Nhw4', 'jk', '/images/avatar-default.png', 0, 0, '2024-11-20 10:07:52', '2024-11-20 10:07:52');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (38, 'shan@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$ktAIz5+MKzyFY2bvMkDtwQ$KqqFxEIgqXCVG9Hs7mXAnEyXvZqt9xiB9fzIP1oVJjY', '1231', '/images/avatar-default.png', 0, 0, '2024-11-20 10:11:36', '2024-11-20 10:11:36');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (39, 'zaim@qq.com', '1111111', '2343434444', '/file_warehouse/images/avatar/users/a8b5f464-1349-47c2-a143-c4a341e7cebb.jpeg', 0, 0, '2024-11-20 10:14:50', '2024-11-20 11:11:59');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (40, 'wsm@qq.com', '555', 'lg为什么', '/file_warehouse/images/avatar/users/163da068-1c06-47e1-afa7-691324c2bb2d.png', 3, 0, '2024-11-20 10:15:48', '2024-11-20 13:18:38');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (1859066856424235009, 'halo@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$Ia7cLqORNum5/MoQU0GOKw$y+51UvNr71rNLSdmTTd5dEDdR/qBJcjsi8pWU9zS6I8', 'halo', 'new-avatar.png', 0, 0, '2024-11-20 10:50:53', '2024-11-20 13:26:20');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (1859103870204981250, 'en@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$FxbaVzjzylvAimo7c3Kk4g$dK4L3fijZnyFpT2TEh6nNe2P0xH3T3t5sE6VPzBsGCo', '嗯', '/file_warehouse/images/avatar/users/43e18798-f27e-4b89-848d-a764cd5fc0a5.jpeg', 0, 2, '2024-11-20 13:17:57', '2024-11-20 15:04:33');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (1859108740748210178, 'psm@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$ko4V2VdB7JUBSYAB4bGP3Q$rAZvDFJmqTn8LTM6ZpGO7BPJ59o6//+NrMBMznK4hx8', '345354', '/file_warehouse/images/avatar/users/91526e08-5e16-4d23-894e-77b014519c81.jpeg', 0, 0, '2024-11-20 13:37:19', '2024-11-20 13:37:19');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (1859109025004580865, '2405824354084@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$vD9+D9b9lVosi3KECDuvUA$vCI16QiiKHKCIuL46gjFVeM+naeGAajrDa8J2X2ydJk', '45345', '/file_warehouse/images/avatar/users/218cbc26-6039-4a7b-bd1e-45ccbca1c421.jpeg', 0, 0, '2024-11-20 13:38:26', '2024-11-20 13:38:26');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (1859109122723475457, '435435@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$VJI0WAHs4VsdrUBUsivutA$+Tf1k9E/UmrU0E/4fvHGYXFmLGSvhoBYqr8BCDuNukY', '6456546', 'http://127.0.0.1:8071/apihttp://127.0.0.1:8071/api/Hello /file_warehouse/images/avatar/users/0f96f389-8b4b-4d41-8aca-16508a9798c0.jpg', 0, 0, '2024-11-20 13:38:50', '2024-11-20 14:54:34');
INSERT INTO `note_user` (`user_id`, `email`, `password`, `nickname`, `avatar`, `subscribe`, `status`, `create_time`, `update_time`) VALUES (1859116936749641729, 'kounijiwa@qq.com', '$argon2i$v=19$m=65536,t=2,p=1$3J9Ra1QnoffzfvAfl/y6Gg$9oDmkg+QyZZE0MO7dv/7pfm62eIaD9QWo/0FXYYVDCI', 'erfewr', '/file_warehouse/images/avatar/users/ec299d91-e352-41f0-aadf-a5d4875284fa.jpg', 0, 3, '2024-11-20 14:09:53', '2024-11-20 15:22:21');
COMMIT;
...
INSERT INTO `sys_menu` (`menu_id`, `parent_id`, `title`, `path`, `component`, `menu_type`, `sort_number`, `authority`, `icon`, `hide`, `meta`, `deleted`, `create_time`, `update_time`) VALUES (100, 99, '套餐管理', '/subscribe/membership', '/vip/valueadded', 0, 1, NULL, 'Ticket', 0, NULL, 0, '2021-02-02 20:15:18', '2024-11-19 23:22:49');
...
INSERT INTO `sys_menu` (`menu_id`, `parent_id`, `title`, `path`, `component`, `menu_type`, `sort_number`, `authority`, `icon`, `hide`, `meta`, `deleted`, `create_time`, `update_time`) VALUES (120, 163, '插件管理', '/templateplugin/plugin', NULL, 0, 2, NULL, 'AppstoreAddOutlined', 0, NULL, 0, '2024-10-11 21:21:17', '2024-11-01 10:16:24');
...
INSERT INTO `sys_menu` (`menu_id`, `parent_id`, `title`, `path`, `component`, `menu_type`, `sort_number`, `authority`, `icon`, `hide`, `meta`, `deleted`, `create_time`, `update_time`) VALUES (140, 163, '模板管理', '/templateplugin/template', NULL, 0, 1, NULL, 'DataAnalysis', 0, NULL, 0, '2024-10-11 21:32:11', '2024-11-01 10:16:19');
...
INSERT INTO `sys_menu` (`menu_id`, `parent_id`, `title`, `path`, `component`, `menu_type`, `sort_number`, `authority`, `icon`, `hide`, `meta`, `deleted`, `create_time`, `update_time`) VALUES (167, 101, '订单统计', '/order/statistics', '', 0, 2, '', 'PieChart', 0, '', 0, '2024-10-14 01:19:47', '2024-11-01 10:16:11');
...
INSERT INTO `sys_menu` (`menu_id`, `parent_id`, `title`, `path`, `component`, `menu_type`, `sort_number`, `authority`, `icon`, `hide`, `meta`, `deleted`, `create_time`, `update_time`) VALUES (169, 150, '用户统计分析', '/customer/analysis', '/customer/analysis', 0, 2, '', 'Aim', 0, '', 0, '2024-11-01 10:19:51', '2024-11-20 01:26:49');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_role` (`role_id`, `role_name`, `role_code`, `comments`, `deleted`, `create_time`, `update_time`) VALUES (1, '管理员', 'admin', '最高管理员', 0, '2024-11-09 23:44:17', '2024-11-09 23:45:41');
INSERT INTO `sys_role` (`role_id`, `role_name`, `role_code`, `comments`, `deleted`, `create_time`, `update_time`) VALUES (2, '普通用户', 'user', '普通用户', 0, '2024-11-09 23:45:32', '2024-11-09 23:45:32');
INSERT INTO `sys_role` (`role_id`, `role_name`, `role_code`, `comments`, `deleted`, `create_time`, `update_time`) VALUES (3, '游客', 'tourist', '游客', 0, '2024-11-09 23:45:32', '2024-11-15 00:07:21');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` (`user_id`, `role_id`, `username`, `password`, `nickname`, `avatar`, `sex`, `phone`, `email`, `email_verified`, `introduction`, `status`, `deleted`, `create_time`, `update_time`) VALUES (123, 1, 'Yoko', '$argon2i$v=19$m=65536,t=2,p=1$zNCXciWe2RiG16IEJcTDcA$SKaCzqNex1uBZOHO61pGNedZ3ZOfyU4x4WMFvJy+ffc', 'Yoko', '/file_warehouse/images/avatar/default/avatar-admin1.png', '男', '17877059806', '2405824084@qq.com', 0, '这个人很懒', 0, 0, '2024-11-09 23:16:54', '2024-11-19 01:44:57');
INSERT INTO `sys_user` (`user_id`, `role_id`, `username`, `password`, `nickname`, `avatar`, `sex`, `phone`, `email`, `email_verified`, `introduction`, `status`, `deleted`, `create_time`, `update_time`) VALUES (456, 2, 'Izcw', '$argon2i$v=19$m=65536,t=2,p=1$zNCXciWe2RiG16IEJcTDcA$SKaCzqNex1uBZOHO61pGNedZ3ZOfyU4x4WMFvJy+ffc', 'Izcw', '/file_warehouse/images/avatar/default/avatar-admin2.png', '女', '18269328567', 'zhang@qq.com', 0, '这个人很懒', 0, 0, '2024-11-09 23:57:30', '2024-11-19 01:45:01');
INSERT INTO `sys_user` (`user_id`, `role_id`, `username`, `password`, `nickname`, `avatar`, `sex`, `phone`, `email`, `email_verified`, `introduction`, `status`, `deleted`, `create_time`, `update_time`) VALUES (789, 3, 'Izcw', '$argon2i$v=19$m=65536,t=2,p=1$zNCXciWe2RiG16IEJcTDcA$SKaCzqNex1uBZOHO61pGNedZ3ZOfyU4x4WMFvJy+ffc', 'nike', '/file_warehouse/images/avatar/default/avatar-admin3.png', '男', '13472583897', 'zhang2@qq.com', 0, '这个人很懒', 0, 0, '2024-11-09 23:57:30', '2024-11-20 09:20:28');
COMMIT;
